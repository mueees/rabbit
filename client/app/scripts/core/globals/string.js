...
//            we want a dependency on goog.array in goog.string?
    ...
    goog.string.format.demuxes_.s = function(value,
        ...
        // and isNaN('') == false.
        if (isNaN(width) || (rss.util.isString(width) && width === '') || replacement.length >= width) {
            return replacement;
        }
    ...
    // Expose the google code through our rss.string object design
    // TODO should we only expose some of the methods and hide things like the demuxes???
    rss.string = goog.string;
